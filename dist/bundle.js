...
var _responsivefy = require('./responsivefy');

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var d3 = require('d3');

var AreaChart = exports.AreaChart = function () {
    ...
    _createClass(AreaChart, [{
        ...
        key: 'createAreaChart',
        value: function createAreaChart() {
            var _this = this;
...
var responsivefy = exports.responsivefy = function responsivefy(svg) {
    ...
    svg.attr('viewBox', '0 0 ' + width + ' ' + height).attr('perserveAspectRatio', 'xMidYMid').call(resize);
